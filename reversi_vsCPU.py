...
class Board:
    ...
    def __init__(self):
        ...
        print("reversi")
        print("")
        HUMAN_COLOR = input("BLACK(先攻) or WHITE(後攻): ")
        if HUMAN_COLOR in ["BLACK" , "black"]:
            self.HumanColor = BLACK
        elif HUMAN_COLOR in ["WHITE" , "white"]:
    ...
    def main_input(self):
        ...
        input_al = "abcdefgh"
        input_num = "12345678"
        if self.CurrentColor == self.HumanColor:
    ...
    def randomInput(self):
        ...
        grids = np.where(self.MovableDir != 0)
